...
document.write(diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear());
        ...
        <div class="logo">
           <img src="logo.png" width="229" height="120">
           </div>
        </header>
    <br>
    <br>
  ...
  // echo $tiposerv; 
   ...
   $html.='<br>
    ...
    <p class="pa1">
        ...
        <br>
        <br>
		En nombre del Hotel Casa Ballesteros Barranquilla, agradecemos de antemano su interés en nuestros servicios.
		<br />
		<br />
        Banquetes, coffe-break, almuerzos, cenas. Galas empresariales, cocteles y fiestas, forman parte de nuestro amplio portafolio de servicios, el HCB se ocupa de la planificación de todos y cada uno de los detalles que harán de su evento  una celebración perfecta.<br>
        <br>
        El HCB ofrece un servicio especializado que garantiza en cada uno de sus eventos el manejo de estándares de calidad exigidos, nuestra estrecha relación con nuestros clientes garantiza el éxito de sus eventos.<br><br>
...
$html.='<tr>
			      ...
			      <td align="center"> '.$resItems["ae_desc_item"].'<br>'. iconv("UTF-8", "ISO-8859-1", $resItems["descripcion"]).'</td>
                                                                 <td align="center">$'.number_format($resItems["ae_valor"],0,'','.').'</td>

<td align="center"><b>('.substr($resItems["iva"],0,2).'%)</b> - $'.number_format($resItems["ae_valor"]*$resItems["cantidad"]*($resItems["iva"]/100),0,'','.'). '</td>';

$iva =$resItems["ae_valor"]*$resItems["cantidad"]*($resItems["iva"]/100);
$iva_total=$iva_total+$iva;

$html.='<td align="center">$'.number_format($resItems["ae_valor"]*$resItems["cantidad"]+$iva,0,'','.').'</td>
		                         </tr>';
				
               	$sub=$sub+$resItems["ae_valor"]*$resItems["cantidad"];
...
<p>&nbsp;</p>	
     <p>Las modificaciones estarán sujetas a las condiciones establecidas contractualmente y a la disponibilidad del HCB. En todos los casos, 72 horas antes del evento no se aceptaran modificaciones en servicios de Alimentos y Bebidas en los menús, ni en cantidades superiores o inferiores al 10% del número de servicios contratados.</p>
<p>&nbsp;</p>	 
...
<p>&nbsp;</p>	 
     <p>Todo el servicio de alimentos y bebidas que se ofrece en nuestras instalaciones, es preparado y presentado en exclusividad por el HCB.</p>
<p>&nbsp;</p>	 
